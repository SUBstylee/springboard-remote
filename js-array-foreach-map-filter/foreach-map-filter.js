...
function showFirstAndLast(arr) {
    let firstAndLast = [];
    arr.forEach(function (a) {
        firstAndLast.push(a[0] + a[a.length - 1]);
    });
    return firstAndLast;
}
...
function find(arr, searchValue) {
    ...
    })[0]; //had to look up how to return undefined
}
...
function removeVowels(str) {
    ...
    }).join('');//had to look this one up. once I figured out to use split and join, it became much easier
}
