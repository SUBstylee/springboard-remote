         ...
         <div class="card" data-show-id="${show.id}">
          <img class="card-img-top" src="${show.image}">
           <div class="card-body">
             ...
             <button id='episodes' class="btn btn-primary">Get Episodes</button>
           </div>
         </div>
       </div>
      `);
...
async function getEpisodes(id) {
  ...
  const episodes = res.data.map(function (episode) {
    return {
      // id: episode.id,
      name: episode.name,
...
$('#shows-list').on('click', '#episodes', async function displayEpisodes(e) {
